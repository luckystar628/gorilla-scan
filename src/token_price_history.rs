...
pub struct TokenPriceHistoryData {
    ...
    pub price_chain: f64,
    pub price_5m: f64,
    pub price_chain_5m: f64,
    pub variation_5m: f64,
    pub variation_chain_5m: f64,
    pub price_1h: f64,
    pub price_chain_1h: f64,
    pub variation_1h: f64,
    pub variation_chain_1h: f64,
    pub price_6h: f64,
    pub price_chain_6h: f64,
    pub variation_6h: f64,
    pub variation_chain_6h: f64,
    pub price_24h: f64,
    pub price_chain_24h: f64,
    pub variation_24h: f64,
    pub variation_chain_24h: f64,   
}
